...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        """
        new_pos_found = False
        while not new_pos_found:
            new_pos = self.position.getNewPosition(self.getRobotDirection(),self.speed)
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        new_pos_found = False
        while not new_pos_found:
            new_pos = self.position.getNewPosition(random.randrange(0,360),self.speed)
            if self.room.isPositionInRoom(new_pos):
                self.setRobotPosition(new_pos)
                self.room.cleanTileAtPosition(new_pos)
                self.setRobotDirection(random.randrange(0,360))
...
#     plot.
#
showPlot1("Percentage","Number of Robots", "Steps taken")
#
...
#       (... your call here ...)
#
showPlot2("Time it takes 2 Robots to clean 80% of variously Shaped Rooms", "Height", "Time-Steps")